...
describe('bascula Test', function () {
    ...
    it('check if bascula is created', function () {
        let basculaConstructor = new Bascula();
        expect(basculaConstructor).to.be.a('object');
        //assert.typeOf(basculaConstructor, "Object");
    });
    ...
    it('check if calcularIMC() is correct', function () {
        ...
        basculaTest.calcularIMC().should.equal(1.1834319526627217);
    });
